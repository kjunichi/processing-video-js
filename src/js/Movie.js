	...
	var Movie = this.Movie = (function(window){
		...
		*/
		var MovieImpl = function () {
			...
			var url = (arguments[1] instanceof Array) ? arguments[1] : [arguments[1]];
			...
			this.read = function () {
				// how to return a PImage?
				return ensureVideoElement() ? new PImage(videoElement) : null;
			};
